...
export default class appWindow {
    constructor(options, mainContentMarkup, trigger) {
        $(trigger).on("click", () => {
            ...
            `);
                ...
                if (device() == "desktop") {
                    ...
                    $(".app-control.MAXIMIZE").each((element) => {
                        $(element).on("click", () => {
...
CalculatorApp.script = function () {
    ...
    function evaluateExpression() {
        try {
            ...
            if (numPlaceholder.value) {
                ...
                if (lastExpression.innerHTML.split(" ")[0] == "=")
    ...
    function updateLastExpression(symbol) {
        numPlaceholder = $ `#number-placeholder`;
        if (numPlaceholder.value) {
            const lastExpression = $ `[app-calculator] h5#last-expression`.element;
            if (lastExpression.innerHTML.includes("=")) {
