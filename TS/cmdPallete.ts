...
class CMDPallete {
    constructor () {
        const cmd_pallete_container: HTMLElement = $`div`.create(true)
        ...
        cmdList.forEach((elem: any) => {
            let shortcutKBD: Array<any> = []
            elem.shortcut.forEach((element: Element) => {
        ...
        var inputArea: any = cmd_pallete_container.querySelector("input");
        inputArea.focus();
        inputArea.value = "> ";
    }
}